...
function initFromMap(x1,y1, x2, y2)
  for i=x1,x2 do 
    for j=y1,y2 do
      ...
      if val == 49 then
        monsters = {next = monsters, x = i, y = j, dir = 0}
      end
      if val == 64 then
        player.x = i
        player.y = j
...
function updateCamera()  
 if game.state == 0 then -- Attract Mode Camera
  camera.x = 72
  camera.y = 8
...
function updatePlayer()
  -- Important player state update for doing nothing
  if game.time %30 == 0 then  player.state = 0 end -- Wait
...
function monsterCanMove(x, y)
  val = mget(x, y)
  if val == 1 or val == 2 or val == 3 or val ==8 or val == 9 or val == 39 or
    val == 10 or val == 11 or val == 12 or val == 23 or
    val == 15 or val == 17 or val == 20 or val == 21 or
    val == 22 or val == 37 or val == 18 or val == 14 then
      return 0
    else
      return 1
  end
...
function drawPlayer()
  ...
  if player.state == 3 then -- Aiming mode
    if player.dir == -1 then
      spr(256, (player.x - camera.x) * 24,
          (player.y - camera.y) * 24, 15, 1, 0, 0, 3, 3)
      spr(271, (player.x - camera.x) * 24 + 9,
...
function drawMonsters()
  ...
  spr(361,
    (m.x - camera.x) * 24,
    (m.y - camera.y) * 24, 15, 1, 0, 0,
    3, 3)
end
if m.dir == 2 then -- Left
  spr(352 + game.time % 30 // 15 * 3,
      (m.x - camera.x) * 24,
      (m.y - camera.y) * 24, 15, 1, 1, 0,
      3, 3)
end
...
function drawHUD()
  if game.state == 0 then -- Attract Mode
    ...
    print (player.life, 216,2,11,1,2)
   end
end
...
function drawMapSprite(val, i, j) 
  ...
  if val == 38 then
   ...
   if game.state == -1 then  -- It's flyBy Mode
    -- Gobelin Sprite	  
    if val == 49 then spr(352,i*24,j*24,-1,1,0,0,3,3) end
    -- Player Sprite	  
    if val == 64 then spr(256,i*24,j*24,15,1,0,0,3,3) 
...
-- 150:0004440000444000044400000444000004444440004444000000000000000ddd
-- 151:0ddddd00d0ddd0d0dd0d0dd0dd0d0dd0ddddddd00ddddd00ddddddd0dddddddd
-- 152:04440000004440000004440000044400444444000444400000000000dd000000
...
-- 178:0000000f0000000f0000440f4004440f0044440f0044440f0444400f000000ff
...
-- <MAP>
-- 000:
-- 001:
-- 002:
-- 003:
-- 004:
-- 005:
-- 006:
-- 007:
-- 008:
-- 009:
-- 010:
-- 011:
-- 012:
-- 013:
-- 014:
-- 015:
-- 016:
-- 017:
...
-- 019:
...
-- 021:
-- 022:
-- 023:
...
-- 029:
...
-- 040:
...
-- 045:
...
-- 051:
-- 052:
-- 053:
-- 054:
-- 055:
-- 056:
-- 057:
-- 058:
-- 059:
-- 060:
-- 061:
-- 062:
-- 063:
-- 064:
-- 065:
-- 066:
-- 067:
-- </MAP>
