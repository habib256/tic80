...
player = {x, y, dir, state = 0, life = 10, O2 = 300}
...
function flyBy()
    ...
    drawMap(camera.x, camera.y)
    -- show coordinates
    c = string.format('(%03i,%03i)', toInt(camera.x), toInt(camera.y))
    rect(0, 0, 52, 8, 0)
    print(c, 0, 0, 12, 1)
end
...
function checkInteraction()
    ...
    while m do
        if m.x == player.x then
            if m.y == player.y then player.life = player.life - 1 end
        end
        m = m.next
    end
end
...
function playerCanMove(x, y)
    val = mget(x, y)
    if val == 1 or val == 2 or val == 3 or val == 39 or val == 10 or val == 11 or
        val == 12 or val == 23 or val == 15 or val == 17 or val == 20 or val ==
        21 or val == 22 or val == 37 or val == 18 then
        return -1
    else
...
function monsterCanMove(x, y)
    ...
    if val == 1 or val == 2 or val == 3 or val == 8 or val == 9 or val == 39 or
        val == 10 or val == 11 or val == 12 or val == 23 or val == 15 or val ==
        17 or val == 20 or val == 21 or val == 22 or val == 37 or val == 18 or
        val == 14 then
        return 0
    else
        return 1
...
function drawPlayer()
    ...
    if player.state == 0 then
        -- En Face
        spr(256, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15, 1,
            0, 0, 3, 3)
        spr(271, (player.x - camera.x) * 24 + 8, (player.y - camera.y) * 24 + 4,
            15, 1, 0, 0, 1, 1)
    end
    ...
    if player.state == 1 then -- Walk 
        ...
        if player.dir == -1 then
            spr(304 + game.time % 30 // 15 * 3, (player.x - camera.x) * 24,
    ...
    if player.state == 2 then -- Swimming mode
        if player.dir == -1 then
            spr(265 + game.time % 30 // 15 * 3, (player.x - camera.x) * 24,
                (player.y - camera.y) * 24, 15, 1, 0, 0, 3, 3)
            spr(271, (player.x - camera.x) * 24 + 9,
                (player.y - camera.y) * 24 + 3 + game.time % 30 // 15, 15, 1, 0,
                0, 1, 1)
        end
        if player.dir >= 0 then
            spr(265 + game.time % 30 // 15 * 3, (player.x - camera.x) * 24,
                (player.y - camera.y) * 24, 15, 1, 0, player.dir, 3, 3)
        end
    end
    ...
    if player.state == 3 then
        if player.dir == -1 then
            spr(256, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15,
                1, 0, 0, 3, 3)
            spr(271, (player.x - camera.x) * 24 + 8,
                (player.y - camera.y) * 24 + 4, 15, 1, 0, 0, 1, 1)
        end
        if player.dir == 0 then
            spr(313, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15,
                1, 0, 0, 3, 3)
        end
        if player.dir == 1 then
            spr(310, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15,
                1, 0, 0, 3, 3)
        end
        if player.dir == 2 then
            spr(316, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15,
                1, 0, 0, 3, 3)
        end
        if player.dir == 3 then
            spr(310, (player.x - camera.x) * 24, (player.y - camera.y) * 24, 15,
...
function drawMonsters()
    ...
    while m do
        if m.dir == -1 then
            spr(352 + game.time % 30 // 15 * 3, (m.x - camera.x) * 24,
                (m.y - camera.y) * 24, 15, 1, m.dir, 0, 3, 3)
        end
        ...
        if m.dir == 1 then -- UP
            spr(361, (m.x - camera.x) * 24, (m.y - camera.y) * 24, 15, 1, 0, 0,
                3, 3)
        end
        if m.dir == 2 then -- Left
            spr(352 + game.time % 30 // 15 * 3, (m.x - camera.x) * 24,
                (m.y - camera.y) * 24, 15, 1, 1, 0, 3, 3)
        end
        if m.dir == 3 then -- Down
            spr(358, (m.x - camera.x) * 24, (m.y - camera.y) * 24, 15, 1, 0, 0,
                3, 3)
        end
        m = m.next
    end
...
function drawMapSprite(val, i, j)
    ...
    -- Pikes
    if val == 7 then spr(160, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Little Skull
    if val == 8 then spr(204, i * 24, j * 24, -1, 1, 0, 0, 3, 2) end
    -- Big Skull
    if val == 9 then spr(236, i * 24, j * 24, -1, 1, 0, 0, 3, 2) end
    -- Aztec Statue
    if val == 10 then spr(163, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Weird Statue
    if val == 11 then spr(118, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Pedestal
    if val == 12 then spr(166, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Book
    if val == 13 then spr(13, i * 24 + 8, j * 24 + 16, -1, 1, 0, 0, 1, 1) end
    -- Water
    if val == 14 then spr(112, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Pillar
    if val == 15 then spr(208, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Tree
    if val == 17 then spr(78, i * 24 + 8, j * 24, -1, 1, 0, 0, 2, 3) end
    -- Rotated Stairs up
    if val == 16 then
    ...
    -- Yellow Door
    if val == 36 then spr(211, i * 24, j * 24, -1, 1, 0, 0, 3, 3) end
    -- Spacechip way
    if val == 38 then
    ...
    if game.state == -1 then -- It's flyBy Mode
        -- Gobelin Sprite	  
        if val == 49 then spr(352, i * 24, j * 24, 15, 1, 0, 0, 3, 3) end
        -- Player Sprite	  
        if val == 64 then
    ...
    -- Yellow Key
    if val == 207 then spr(val, i * 24 + 8, j * 24 + 8, -1, 1, 0, 0, 1, 1) end
    -- Red Key
    if val == 223 then spr(val, i * 24 + 8, j * 24 + 8, -1, 1, 0, 0, 1, 1) end
    -- Green Key
